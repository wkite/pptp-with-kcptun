...
if(!file_exists('/tmp/sync.db')) createDbUsers();
...
function createDbUsers(){
    ...
    //echo '<br>insert: Admin - token: ' . $ret = $db->newUser('admin', 'admin','Admin', 'Author & Administrator','root@localhost', 10);
    $x = $db->getUsers();
    //p($x, true);
}
        ...
        <div class="topbar">
            <div id="menu" onclick="toggleMenu();">Menu
                <ul id="submenu" class="submenu">
                    <li><a href="<?php echo URL;?>terminal.php?command=ls -ls">List Directory</a></li>
                    <li><a href="<?php echo URL;?>terminal.php?command=cd /var/www/html/media/Downloads">cd Downloads</a></li>
                    <li><a href="./media/Downloads">Goto Downloads</a></li>
